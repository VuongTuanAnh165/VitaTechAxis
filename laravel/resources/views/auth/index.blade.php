        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <a href="" class="-intro-x flex items-center pt-5">
                    ...
                    <span class="text-white text-lg ml-3"> {{ $business->name }} </span>
                </a>
                <div class="my-auto">
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <form action="" class="validate-form" novalidate="true"
                        method="POST">
                        {{ csrf_field() }}
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            <button
                                class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">{{ __('messages.web.auth.login') }}</button>
                        </div>
                    </form>
                </div>
            </div>
